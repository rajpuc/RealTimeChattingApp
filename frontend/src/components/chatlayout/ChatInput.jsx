import { Cross, Paperclip, Send, Upload, X } from "lucide-react";
...
function ChatInput({ chat }) {
  ...
  const { sendMessageToChat, selectedUser } = useChatStore();
  ...
  const handleSendMessage = async () => {
    ...
    const response = await sendMessageToChat(data);
